public class ChecklistGoal: Goals
{
    ...
    public ChecklistGoal(string name="Name", string description="Description", string points="0", bool finished=false, bool eternal=true, int times=0, int counter=0, int bonus=0): base(name, description, points, finished, eternal)
    {
        _numberTimes = times;
        _counter = counter;
        _bonus = bonus;
